<template>
    <div>
        ...
        <AnneeFormationForm
            :visible="anneeFormationFormVisible"
            :anneeToEdit="anneeToEdit"
            @update:visible="anneeFormationFormVisible = $event"
            @save="handleSaveAnnee"
            @update="handleUpdateAnnee"
            @close="closeAnneeFormationForm"
        />
...
import AnneeFormationForm from '@/Components/Forms/AnneeFormationForm.vue';
...
export default {
    ...
    data() {
        return {
            ...
            anneeFormationFormVisible: false,
    ...
    methods: {
        ...
        openAnneeFormationForm() {
            ...
            this.anneeFormationFormVisible = true;
        },
        closeAnneeFormationForm() {
            this.anneeFormationFormVisible = false;
