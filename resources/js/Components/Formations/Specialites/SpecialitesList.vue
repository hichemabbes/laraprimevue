...
import SpecialiteAdd from '@/Components/Formations/Specialites/SpecialiteAdd.vue';
import SpecialiteEdit from '@/Components/Formations/Specialites/SpecialiteEdit.vue';
