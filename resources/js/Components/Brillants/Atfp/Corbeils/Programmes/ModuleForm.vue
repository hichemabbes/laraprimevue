<template>
    ...
    >
        ...
        <div class="flex flex-column gap-4">
            ...
            <!-- Type DocumentProgrammeSpecialite Field -->
            <div class="field">
                <label for="type_module" class="block font-medium mb-2"
                    >Type Module</label
                >
                <Dropdown
                    id="type_module"
                    v-model="newModule.type_module"
...
export default {
    ...
    props: {
        ...
        programmeId: { type: Number, default: null },
    ...
    data() {
        return {
            ...
            typeModuleOptions: [
                { label: 'Théorique', value: 'Théorique' },
    ...
    watch: {
        ...
        programmeId: {
            immediate: true,
            handler(newVal) {
                this.newModule.version_id = newVal;
            },
        },
        visible(newVal) {
            if (!newVal) {
