            ...
            <div class="flex flex-column gap-3">
                <div class="flex align-items-center gap-3">
                    ...
                    <span>
                        ...
                        <b>{{
                            periodeToDelete?.type_repos_formation_fr ||
                            'Non défini'
                        }}</b>
                        ?
                    </span>
...
import AnneeFormationForm from '@/Components/Annees/AnneeFormationForm.vue';
import PeriodeReposFormationForm from '@/Components/Annees/PeriodeReposFormationForm.vue';
    ...
    methods: {
        ...
        async fetchAnneesFormation() {
            ...
            try {
                ...
                if (!Array.isArray(response.data)) {
                    throw new Error('Réponse des années de formation invalide');
                }
                this.anneesFormation = response.data;
                if (
                    !this.anneesFormation.some(
                    ...
                    this.toast.add({
                        severity: 'info',
                        summary: 'Information',
                        detail: 'Aucune période de repos trouvée pour les années de formation.',
                        life: 3000,
                    });
                }
            } catch (error) {
                ...
                this.toast.add({
                    severity: 'error',
                    summary: 'Erreur',
                    detail: 'Erreur lors du chargement des années de formation.',
                    life: 3000,
                });
            ...
            try {
                ...
                this.showSuccess(
                    response.data.message ||
                        'Année de formation supprimée avec succès.'
                );
                this.deleteFormVisible = false;
                this.anneeToDelete = null;
                this.deletePassword = '';
        ...
        async deletePeriode() {
            ...
            try {
                ...
                if (annee) {
                    annee.repos_formations = annee.repos_formations.filter(
        ...
        handleUpdateAnnee(updatedAnnee) {
            ...
            if (index !== -1) {
                this.anneesFormation[index] = {
                    ...
                    repos_formations:
                        this.anneesFormation[index].repos_formations || [],
                };
            }
            this.closeForm();
        },
        handleSavePeriode(periode) {
            ...
            if (annee) {
                annee.repos_formations = annee.repos_formations || [];
                annee.repos_formations.push(periode);
        ...
        handleUpdatePeriode(updatedPeriode) {
            ...
            if (annee) {
                const index = annee.repos_formations.findIndex(
                    (p) => p.id === updatedPeriode.id
                );
                if (index !== -1) {
                    annee.repos_formations[index] = updatedPeriode;
                    this.showSuccess(
