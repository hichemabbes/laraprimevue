...
const block2 =
    ref(` <div class="surface-section px-4 py-8 md:px-6 lg:px-8 text-center">
...
const block8 =
    ref(` <div class="surface-card p-4 shadow-2 border-round w-full lg:w-6">
            ...
            <div class="surface-section px-4 py-8 md:px-6 lg:px-8 text-center">
                ...
                <div class="grid">
                    ...
                    <div class="col-12 md:col-4 mb-4 px-5">
                        ...
                        >
                            <i
                                class="pi pi-check-circle text-4xl text-blue-500"
                            ></i>
                        </span>
                        <div class="text-900 mb-3 font-medium">Easy to Use</div>
                        <span class="text-700 text-sm line-height-3"
                ...
                <ul class="list-none p-0 m-0">
                    ...
                    >
                        ...
                        >
                            ...
                            the heat from police when they unknowingly leave a
        ...
        >
            <div class="surface-card p-4 shadow-2 border-round">
                ...
                <div class="font-medium text-500 mb-3">
                    Vivamus id nisl interdum, blandit augue sit amet, eleifend
                    mi.
                </div>
                <div
                    style="height: 150px"
