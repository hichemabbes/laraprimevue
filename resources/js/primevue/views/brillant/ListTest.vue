    ...
    <div>
        ...
        <div class="card" style="overflow-x: auto">
            ...
            <div class="flex mb-3">
                ...
                <Button
                    label="غير مقيس"
                    :severity="activeTab === 'غير مقيس' ? 'danger' : 'danger'"
                    class="mr-2 arabic-normal"
        ...
        <!-- Popup pour les documents -->
        <DocumentPopup
            v-if="selectedSpecialite"
            :specialiteId="selectedSpecialite.id"
            :selectedAnnee="selectedAnnee"
            v-model:visible="documentPopupVisible"
        />
        ...
        <ModulePopup
            ...
            :specialiteId="selectedSpecialite.id"
            :selectedAnnee="selectedAnnee"
            v-model:visible="modulePopupVisible"
        />

        <!-- Popup pour associer les spécialités à un secteur -->
        <Dialog
            v-model:visible="associateSecteurFormVisible"
            :style="{ width: '30vw' }"
            ...
            <div>
                ...
                <div class="flex justify-content-end">
                    <Button
                        ...
                        icon="pi pi-times"
                        class="p-button-text"
                        @click="associateSecteurFormVisible = false"
                    />
                    <Button
                        label="Associer"
                        icon="pi pi-check"
        ...
        >
            <div>
                <div class="flex flex-column gap-3">
                    <Button
                        label="Importer des spécialités"
                        icon="pi pi-file-import"
                        class="p-button-success"
                        @click="importSpecialites"
                    />
                    <Button
