...
<template>
    <div class="grid">
        <div class="col-12 xl:col-4">
            <div class="card">
                <div
                    class="px-4 py-2 shadow-2 flex flex-column md:flex-row md:align-items-center justify-content-between mb-3"
                    style="
                        border-radius: 1rem;
                        background:
                            linear-gradient(
            ...
            <div class="card">
                <div class="flex justify-content-between align-items-top mb-5">
